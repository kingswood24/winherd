         ...
         try
            with TempBeefRep do
              begin
                 ...
                 FieldDefs.Add('HerdIdentity',ftString,20);
                 FieldDefs.Add('NatIDShort',ftString,20);
...
procedure TEligibilityRep.QRDBFQASPrint(sender: TObject;
  var Value: String);
begin
   if RptQuery.FieldByName('QADate').AsDateTime <= 0 then
      Value := '';
end;
...
procedure TEligibilityRep.SetSalesPlannerReportType(
  const Value: TSalesPlannerReportType);
begin
            ...
            begin
               if ( FSalesPlannerReportType <> rtNonFQAS ) then
                  ...
                  begin
                     ...
                     OrderRadio.Top := SortByRadio.Top;
                     PBar.Top := SortByRadio.Top + SortByRadio.Height + 10;
                  end;
            end;
