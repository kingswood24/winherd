{
   22/04/15 [V5.4 R4.0] /MK Change - FormCreate - Default CustomerID MaxLength to 12 - TGM request.
}
...
begin
   ...
   FUserChange := False;
   //   22/04/15 [V5.4 R4.0] /MK Change - Default CustomerID MaxLength to 12 - TGM request.
   tbCustomerId.Properties.MaxLength := 12;
end;
