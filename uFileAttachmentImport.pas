...
begin
   ...
   with MemData do
      try
         ...
         CreateMemDataFieldDef(MemData,'FileType',ftDateTime);
         CreateMemDataFieldDef(MemData,'FileDate',ftString,10);
                  ...
                  begin
                     ...
                     if ( Length(HerdIdentifier) > 0 ) then
                        try
                           ...
                           MemData.Append;
                           MemData.FieldByName('FileName').AsString := FileName;
      ...
      while ( not(MemData.Eof) ) do
         begin
            ...
            ListItem.Caption := MemData.FieldByName('FileName').AsString;
            ListItem.Data := pointer(MemData.FieldByName('FileName').AsString);
            if ( MemData.FieldByName('FileDate').AsDateTime > 0 ) then
               ListItem.SubItems.Add(FormatDateTime('dd of mmm yyyy', MemData.FieldByName('FileDate').AsDateTime));
            if ( Length(MemData.FieldByName('FileType').AsString) > 0 ) then
