inherited fmLivestockValues: TfmLivestockValues
  Top = 160
  Width = 586
  Height = 539
  Caption = 'Livestock Values'
  OldCreateOrder = True
  OnShow = FormShow
  PixelsPerInch = 96
  TextHeight = 13
  ...
  object cxGroupBox3: TcxGroupBox [1]
    Left = 38
    Top = 382
    Caption = 'Opening/Closing Inventory Values'
    ParentFont = False
    ...
    object DBEdit15: TcxDBTextEdit
      Left = 125
      Top = 31
      DataBinding.DataSource = WinData.dsLiveStockValues
      ParentFont = False
      Style.Color = 12639424
      Style.Font.Charset = ANSI_CHARSET
      Style.Font.Color = clWindowText
      Style.Font.Height = -11
      Style.Font.Name = 'Segoe UI'
  ...
  object cxGroupBox1: TcxGroupBox [3]
    ...
    object cxDBComboBox1: TcxDBComboBox
      Left = 192
      Top = 16
      DataBinding.DataField = 'EnterpriseType'
      DataBinding.DataSource = WinData.dsLiveStockValues
