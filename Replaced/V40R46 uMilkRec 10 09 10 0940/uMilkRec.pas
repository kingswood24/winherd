...
//                12/08/10 [V4.0 R4.1] /MK Change - Check For Characters Other Than The UK.
                  ...
                  if ( Copy(NatIDNum, 1,2) = 'UK') then
                     begin
                        NatIDNum := ( Copy(NatIDNum, 3,Length(NatIDNum) ));
                     end
                  else
                     if ( Copy(NatIDNum, 1,2) = 'IE') then
                        begin
                           NatIDNum := ( Copy(NatIDNum, 3,Length(NatIDNum) ));
                        end;

//                12/08/10 [V4.0 R4.1] /MK Change - Program is removing all Alpha Characters which does not check for old tags.
