 ...
 ** Modified 19/09/2002.
 ...
 17/08/10 [V4.0 R4.4] /MK Bug Fix - TempCalvingAfterScroll was not set to look at DefaultNatIDMask where DefCountry <> Ireland.
 }
...
var
   ...
   bLeadZero, NatIDGenerated : Boolean;
begin
            ...
            begin
               if ( not ActivePDAEvents ) then
                  begin
                     ...
                     else if ( HerdLookup.HerdOwnerData.InputNatIDStyle=cInputNatIDStyle_ListInput ) then
                        begin
                           TempCalvingNatID.EditMask := '';
         ...
         if (RegCountry = NIreland) then
            begin
               ...
               if TempCalvingCalfDead.AsBoolean then
                  begin
                     if (Trim(TempCalvingNatID.AsString) = '') then
