...
const
  HerdVerNo = 'KHM V4.0 R5.1';
  iHerdVerNo = 4051; // New Fertility Event - After Calving - Cow womb inspection

   // 06/10/10 [V4.0 R5.0] /MK Change - uElecWeigh - Read and Record moved to the same button.
