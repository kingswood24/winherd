...
type
  TfmAIMAnimalPurchaseEdit = class(TfmBaseForm)
    lInfo: TcxLabel;
    AnimalGrid: TcxGrid;
  ...
  public
    { Public declarations }
    class procedure Load(FAnimals : TIntArray);
  end;

var
  fmAIMAnimalPurchaseEdit: TfmAIMAnimalPurchaseEdit;
...
class procedure TfmAIMAnimalPurchaseEdit.Load(FAnimals: GenTypesConst.TIntArray);
begin
   with TfmAIMAnimalPurchaseEdit.Create(nil) do
      try
         LoadGrid(FAnimals);
         ShowModal;
      finally
...
procedure TfmAIMAnimalPurchaseEdit.LoadGrid(AAnimals: TIntArray);
var
   i : Integer;
begin
...
function TfmAIMAnimalPurchaseEdit.UpdateAnimals() : Boolean;
var
...
procedure TfmAIMAnimalPurchaseEdit.FormCloseQuery(Sender: TObject;
