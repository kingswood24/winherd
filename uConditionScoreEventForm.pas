...
begin
  ...
  try
     ...
     FConditionScoreEvent.AssociatedEventID := ClassDefaultAssociatedEventID;
...
class function TfmConditionScoreEvent.GetDefaultAssociatedEventID: Integer;
begin
   Result := TfmConditionScoreEvent_AssociatedEventID;
end;

class procedure TfmConditionScoreEvent.SetClassAssociatedEventID(
  const Value: Integer);
begin
