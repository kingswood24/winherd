object fmClearDiseaseTestDate: TfmClearDiseaseTestDate
  Left = 652
  Top = 370
  BorderStyle = bsDialog
  Caption = 'Clear Disease Test Date'
  ClientHeight = 141
  ClientWidth = 350
  Color = clBtnFace
  ...
  PixelsPerInch = 96
  TextHeight = 17
  object cmboDiseaseType: TcxComboBox
    Left = 168
    Top = 27
  ...
  object lDiseaseType: TcxLabel
    Left = 61
    Top = 29
    Caption = 'Disease Type :'
  end
  object btnClearDiseaseDate: TcxButton
    Left = 39
    Top = 77
    Width = 171
    Height = 32
    Caption = 'Clear Disease Test Date'
    TabOrder = 2
    OnClick = btnClearDiseaseDateClick
    Glyph.Data = {
